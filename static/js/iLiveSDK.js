    ...
    */
    setRoomEventListener: function (listener) {
        this.ilive.setRoomEventListener(function (eventid, identifier) {
            var roomevent = new ILiveRoomEvent(eventid, identifier);
            listener(roomevent);
        });
    },
...
Vue.prototype.ILiveMessage = ILiveMessage
Vue.prototype.E_iLiveAuthBits = E_iLiveAuthBits
Vue.prototype.E_iLiveMessageElemType = E_iLiveMessageElemType
