<template>
  <div class="main-body">
    <el-container style="min-width:1106px; max-width: 1600px;padding-bottom: 20px;margin: 0 auto">
      <el-header>
            ...
            <div class="video-footer">
              <el-row class="clearfix">
                ...
                <el-col :span="2" class="cz" style="height: 100%;">
                  <h1>操作</h1>
                  <el-button type="primary" size="small" @click="userApplyMicrophone" circle v-if="IsAllowChat">
                    申 请 上 麦
      ...
      <object id="cabid" classid="CLSID:54E71417-216D-47A2-9224-C991A099C531"
              codebase="../../../static/js/iLiveSDK.cab#version=1,7,1,0">
      </object>
    </el-container>
    <div id="promDiv"
         style="background:rgba(0,0,0,.8);width:100%;height:100%;position:absolute;top:0;right:0;left:0;bottom:0;margin:auto;z-index:9999;display:none">

      <p style="width:40%;height:90%;margin:auto;margin-top:2%">
        <img src="../../assets/prompt.png"
             style="height:100%;width:100%;margin-top:20px;margin-bottom:20px;margin:0 auto">
      </p>
...
//          this.sdk.joinRoom(this.roomCode, this.E_iLiveAuthBits.AuthBit_Guest, 'Guest', this.joinSuccess, this.joinError)
      ...
      joinSuccess(data) {
        ...
        this.sdk.sendGroupMessage(message, function () {
        }, this.enterMsgError)
      },
      joinError(data) {
...
//      console.log(this.memberVideo)
      ...
      listenerMsg(data) {
        if (this.roomMembers[data.sender]) {
          ...
          this.GetUserInfo(data.sender, name => {
            this.applyMsgContent(data, name)
          })
        }
      },
      // 渲染聊天内容
      ...
      userApplyMicrophone() {
        ...
        this.sdk.sendC2CMessage(this.master[0].code, message, function () {
        }, this.enterMsgError)
...
//      this.memberVideo[this.mySelfRenderVideoIndex].freeRender()
      ...
      isBan() {
        return this.$ajax.post('/live/ValidateBanOrKick', {roomnum: this.roomCode, isBan: true})
          .then(res => {
